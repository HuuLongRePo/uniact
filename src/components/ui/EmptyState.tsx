...
export function NoActivitiesFound() {
  return (
    <EmptyState
      ...
      description="Các hoạt động sẽ hiển thị ở đây khi có."
    />
  );
}
...
export function NoStudentsFound() {
  return (
    <EmptyState
      ...
      description="Danh sách học viên sẽ hiển thị ở đây."
    />
  );
}
...
export function NoScoresYet() {
  return (
    <EmptyState
      ...
      title="Chưa có điểm"
      description="Điểm của bạn sẽ hiển thị sau khi tham gia hoạt động và được đánh giá."
    />
  );
}
