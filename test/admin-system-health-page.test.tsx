      ...
      if (url === '/api/admin/system-health') {
        return {
          ...
          json: async () => ({
            ...
            activities: { total: 4, planned: 1, ongoing: 1, completed: 2, cancelled: 0, new_24h: 0 },
            ...
            classes: { total: 3 },
            awards: { total: 2 },
            system: { uptime_hours: 5, memory: { heap_used_mb: '100', heap_total_mb: '200' }, node_version: 'v22', platform: 'win32' },
            top_activities: [],
            recent_errors: [],
          ...
          json: async () => ({
            data: {
              readiness: {
                ...
                blockers: ['Face biometric runtime đang bị tắt'],
