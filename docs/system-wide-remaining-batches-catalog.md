...
- Cap nhat 2026-04-25 (tiep 18): da gop 2 follow-up docs trung lap cua domain teacher activity scope/UX vao 1 canonical file (`docs/teacher-activity-scope-and-ux-followup-tasks.md`), archive file cu vao `docs/archive/post-consolidation-2026-04-25/`, va harden them route `GET /api/admin/database/download` (validation text + header contract regression) trong batch 9.107; RB-10 con tiep tuc merge follow-up docs trung lap cac domain con lai va cleanup message legacy residual.
